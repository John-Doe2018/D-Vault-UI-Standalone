				...
				$mybook_images.each(function() {
					...
					$('<img/>').load(function() {
						...
						if (loaded == cnt_images) {
							...
							$mybook.show().booklet({
								name : null,
								// name of the booklet to display in the
								// document title bar
								width : 800,
								// container width
								height : 500,
								...
								// organization, default LTR, left to right, can
								// be
								...
								// used with "closed", "menu" and
								// "chapterSelector",
								// determines chapter name of blank starting
								// page
								...
								// determines chapter name of blank ending page
								covers : false,
								// used with "closed", makes first and last
								// pages
								// into covers, without page numbers (if
								// enabled)
								...
								// page on hover
								overlays : false,
								// enables navigation using a page sized
								// overlay,
								...
								pageSelector : false,
								// enables navigation with a dropdown menu of
								// pages,
								// requires 'menu'
								...
								// callback invoked before each page turn
								// animation
								after : function() {
								}
